...
- [Capítulo III: Requirements Specification](#capítulo-iii-requirements-specification)
  ...
  - [4.1 Strategic-Level Domain-Driven Design.](#41-strategic-level-domain-driven-design)
    ...
    - [4.1.1.3 Bounded Context Canvases.](#4113-bounded-context-canvases)
      - [**Bounded Context: Evaluation Management (Core)**](#bounded-context-evaluation-management-core)
      - [**Bounded Context: IoT Monitoring Management**](#bounded-context-iot-monitoring-management)
      - [**Bounded Context: Operations Management (Flags)**](#bounded-context-operations-management-flags)
      - [**Bounded Context: Logistics Management**](#bounded-context-logistics-management)
      - [**Bounded Context: Actuation Management**](#bounded-context-actuation-management)
  ...
  - [4.2. Tactical-Level Domain-Driven Design](#42-tactical-level-domain-driven-design)
    - [4.2.1. Bounded Context: Monitoreo IoT](#421-bounded-context-monitoreo-iot)
        - [4.2.1.1 Domain Layer](#4211-domain-layer)
        - [4.2.1.2 Interface Layer](#4212-interface-layer)
        - [4.2.1.3 Application Layer](#4213-application-layer)
        - [4.2.1.4 Infrastructure Layer](#4214-infrastructure-layer)
        - [4.2.1.5 Component Diagram (C4)](#4215-component-diagram-c4)
        - [4.2.1.6 UML (Domain)](#4216-uml-domain)
        - [4.2.1.7 Database](#4217-database)
    - [4.2.2. Bounded Context: Evaluación (Core)](#422-bounded-context-evaluación-core)
      - [4.2.2.1. Domain Layer](#4221-domain-layer)
      - [4.2.2.2 Interface Layer](#4222-interface-layer)
      - [4.2.2.3 Application Layer](#4223-application-layer)
      - [4.2.2.4 Infrastructure Layer](#4224-infrastructure-layer)
      - [4.2.2.5 Component Diagram](#4225-component-diagram)
      - [4.2.2.6 UML](#4226-uml)
      - [4.2.2.7 Database](#4227-database)
    - [4.2.3. Bounded Context: Gemelo Digital](#423-bounded-context-gemelo-digital)
      - [4.2.3.1 Domain Layer](#4231-domain-layer)
      - [4.2.3.2 Interface Layer](#4232-interface-layer)
      - [4.2.3.3 Application Layer](#4233-application-layer)
      - [4.2.3.4 Infrastructure Layer](#4234-infrastructure-layer)
      - [4.2.3.5 Component Diagram](#4235-component-diagram)
      - [4.2.3.6 Database](#4236-database)
    - [4.2.4 Bounded Context: Logística](#424-bounded-context-logística)
      - [4.2.4.1 Domain Layer](#4241-domain-layer)
      - [4.2.4.2 Interface Layer](#4242-interface-layer)
      - [4.2.4.3 Application Layer](#4243-application-layer)
      - [4.2.4.4 Infrastructure Layer](#4244-infrastructure-layer)
      - [4.2.4.5 Database](#4245-database)
    - [4.2.4. Bounded Context: Control y Actuación](#424-bounded-context-control-y-actuación)
      - [4.2.4.1. Domain Layer](#4241-domain-layer-1)
      - [4.2.4.2. Interface Layer](#4242-interface-layer-1)
      - [4.2.4.3. Application Layer](#4243-application-layer-1)
      - [4.2.4.4. Infrastructure Layer](#4244-infrastructure-layer-1)
...
<img src="img/LeanUX.jpg" width="800px">
...
### 4.2.1. Bounded Context: Monitoreo IoT

##### 4.2.1.1 Domain Layer

| Tipo           | Clase / Nombre         | Descripción                         | Atributos / Valores clave                             |
| -------------- | ---------------------- | ----------------------------------- | ----------------------------------------------------- |
| Entity         | SensorDevice           | Dispositivo físico de sensores      | id, type, status                                      |
| Entity         | RawSensorReading       | Lectura cruda de sensores           | id, timestamp, deviceId, data                         |
| Value Object   | SensorData             | Datos medidos por sensores          | temperature, humidity, vibration, latitude, longitude |
| Domain Service | DataAcquisitionService | Validación y normalización de datos | validate(), normalize()                               |
| Repository     | RawReadingRepository   | Persistencia de lecturas            | save(), findLatest()                                  |
| Domain Event   | SensorDataReceived     | Evento de recepción de datos        | readingId, deviceId, timestamp                        |

---

##### 4.2.1.2 Interface Layer

| Tipo       | Clase / Nombre      | Descripción          | Métodos / Endpoints                        |
| ---------- | ------------------- | -------------------- | ------------------------------------------ |
| Controller | SensorController    | Ingesta de datos     | POST /api/sensor-data                      |
| Consumer   | SensorEventConsumer | Consumo desde broker | consume(event)                             |
| DTO (in)   | SensorDataResource  | Request de datos     | temperature, humidity, vibration, lat, lng |

---

##### 4.2.1.3 Application Layer

| Tipo            | Clase / Nombre          | Descripción                    | Métodos                         |
| --------------- | ----------------------- | ------------------------------ | ------------------------------- |
| Command Handler | IngestSensorDataHandler | Procesa datos entrantes        | handle(IngestSensorDataCommand) |
| Event Handler   | SensorDataPublisher     | Publica evento para evaluación | on(SensorDataReceived)          |
...
| ----------- | ------------------------ | ------------------------- | -------------- |
| Repository  | RawReadingRepositoryImpl | Persistencia              | PostgreSQL     |
| Messaging   | BrokerAdapter            | Integración con broker    | Kafka/RabbitMQ |
| Integration | DeviceGatewayAdapter     | Comunicación con sensores | IoT Gateway    |

---

##### 4.2.1.5 Component Diagram (C4)

| Componente              | Descripción      |
| ----------------------- | ---------------- |
| SensorEventConsumer     | Entrada de datos |
| IngestSensorDataHandler | Procesamiento    |
| DataAcquisitionService  | Validación       |
| RawReadingRepository    | Persistencia     |
...
| ------------------------------------ | ---------------------------------------- |
| SensorDevice 1..\* RawSensorReading  | Un dispositivo genera múltiples lecturas |
| RawSensorReading contiene SensorData | Composición                              |
...
| Tabla               | Campos                                                                         |
| ------------------- | ------------------------------------------------------------------------------ |
| sensor_devices      | id (PK), type, status                                                          |
| raw_sensor_readings | id (PK), device_id (FK), timestamp, temperature, humidity, vibration, lat, lng |

---

### 4.2.2. Bounded Context: Evaluación (Core)

#### 4.2.2.1. Domain Layer

| Tipo           | Clase / Nombre        | Descripción             | Atributos                   |
| -------------- | --------------------- | ----------------------- | --------------------------- |
| Entity         | EvaluationResult      | Resultado de evaluación | id, status, evaluatedAt     |
| Entity         | Flag                  | Alerta generada         | id, type, severity          |
| Value Object   | Threshold             | Umbrales de evaluación  | metric, min, max            |
| Domain Service | RiskEvaluationService | Evaluación de riesgo    | evaluate(), generateFlags() |
| Domain Event   | EvaluationCompleted   | Resultado listo         | resultId, status            |

---

#### 4.2.2.2 Interface Layer

| Tipo       | Clase                | Descripción        | Endpoints           |
| ---------- | -------------------- | ------------------ | ------------------- |
| Controller | EvaluationController | Consulta de estado | GET /api/evaluation |
| Consumer   | EvaluationConsumer   | Recibe datos IoT   | consume(event)      |

---

#### 4.2.2.3 Application Layer

| Tipo            | Clase                  | Descripción     | Métodos                 |
| --------------- | ---------------------- | --------------- | ----------------------- |
| Command Handler | EvaluateReadingHandler | Evalúa datos    | handle()                |
| Event Handler   | AlertPublisher         | Publica alertas | on(EvaluationCompleted) |

---

#### 4.2.2.4 Infrastructure Layer

| Tipo       | Clase                    | Descripción  | Notas      |
| ---------- | ------------------------ | ------------ | ---------- |
| Repository | EvaluationRepositoryImpl | Persistencia | PostgreSQL |
| Messaging  | BrokerAdapter            | Eventos      | Async      |
...
| Componente             | Descripción   |
| ---------------------- | ------------- |
| EvaluationConsumer     | Entrada       |
| EvaluateReadingHandler | Procesamiento |
| RiskEvaluationService  | Lógica        |
...
| Relación                    | Descripción                         |
| --------------------------- | ----------------------------------- |
| EvaluationResult 1..\* Flag | Un resultado genera múltiples flags |
...
| Tabla              | Campos                             |
| ------------------ | ---------------------------------- |
| evaluation_results | id, status, evaluated_at           |
| flags              | id, type, severity, result_id (FK) |

---

### 4.2.3. Bounded Context: Gemelo Digital

#### 4.2.3.1 Domain Layer

| Tipo           | Clase             | Descripción      | Atributos                                  |
| -------------- | ----------------- | ---------------- | ------------------------------------------ |
| Aggregate Root | DigitalTwin       | Estado del envío | id, shipmentId, currentState, lastUpdated  |
| Value Object   | StateSnapshot     | Estado puntual   | temperature, humidity, vibration, location |
| Domain Service | TwinUpdateService | Actualiza estado | update(), snapshot()                       |
| Domain Event   | TwinUpdated       | Cambio de estado | twinId, timestamp                          |
...
| Tipo       | Clase                 | Descripción     | Endpoints          |
| ---------- | --------------------- | --------------- | ------------------ |
| Controller | DigitalTwinController | Consulta estado | GET /api/twin/{id} |
...
| Tipo            | Clase             | Descripción     | Métodos  |
| --------------- | ----------------- | --------------- | -------- |
| Command Handler | UpdateTwinHandler | Actualiza twin  | handle() |
| Query Handler   | GetTwinHandler    | Consulta estado | handle() |
...
| ---------- | ------------------------- | ------------ |
| Repository | DigitalTwinRepositoryImpl | Persistencia |
...
| Tabla         | Campos                                        |
| ------------- | --------------------------------------------- |
| digital_twins | id, shipment_id, last_updated                 |
| snapshots     | id, twin_id, temperature, humidity, vibration |

---

### 4.2.4 Bounded Context: Logística

#### 4.2.4.1 Domain Layer

| Tipo           | Clase           | Descripción     | Atributos                |
| -------------- | --------------- | --------------- | ------------------------ |
| Entity         | Route           | Ruta del envío  | id, startPoint, endPoint |
| Entity         | GeoFence        | Área geográfica | id, definition           |
| Value Object   | Location        | Coordenadas     | lat, lng                 |
| Domain Service | GeoFenceService | Validación      | isInside(), detectExit() |
...
| Tipo       | Clase               | Descripción      | Endpoints       |
| ---------- | ------------------- | ---------------- | --------------- |
| Controller | LogisticsController | Gestión de rutas | GET /api/routes |
...
| Tipo            | Clase                | Descripción |
| --------------- | -------------------- | ----------- |
| Command Handler | TrackLocationHandler | Seguimiento |
...
| Tipo       | Clase               | Descripción  |
| ---------- | ------------------- | ------------ |
| Repository | RouteRepositoryImpl | Persistencia |
...
| Tabla     | Campos                     |
| --------- | -------------------------- |
| routes    | id, start_point, end_point |
| geofences | id, definition             |
